...
pub fn simplification(mut linear: LinkedList<C>, constraint_storage: &mut ConstraintStorage, mut forb: HashSet<usize>, no_labels: usize, max_signal: usize,  field: BigInt, apply_simp: bool) -> SignalMap {
